...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const List >::type persistence_in(persistence_inSEXP);
    rcpp_result_gen = Rcpp::wrap(bvar_cpp(Y, X, M, T, K, draws, burnin, intercept, priorIntercept, PHI, PHI0, priorPHI_in, priorL_in, L, SV, priorHomoscedastic, sv_spec, h, sv_para, i_mat, i_vec, progressbar, persistence_in));
...
static const R_CallMethodDef CallEntries[] = {
    {"_bayesianVARs_bvar_cpp", (DL_FUNC) &_bayesianVARs_bvar_cpp, 23},
