...
#' base (McCracken and Ng, 2021). Release date 2021-07. Data is transformed to
#' be interpreted as growth-rates (first log-differences with the exception of
#' interest rates, which are already growth rates).
#'
...
#'   \url{https://www.stlouisfed.org/-/media/project/frbstl/stlouisfed/research/fred-md/historical-vintages-of-fred-qd-2018-05-to-2024-12.zip}.
