...
bvar_cpp <- function(Y, X, M, T, K, draws, burnin, PHI, PHI_prior, L, V_i, V_i_L, sv_spec, h, sv_para, progressbar) {
    .Call(`_bayesianVARs_bvar_cpp`, Y, X, M, T, K, draws, burnin, PHI, PHI_prior, L, V_i, V_i_L, sv_spec, h, sv_para, progressbar)
}
...
gibbs_cpp <- function(N, thin) {
    .Call(`_bayesianVARs_gibbs_cpp`, N, thin)
}
