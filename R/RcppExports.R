...
find_rotation_cpp <- function(parameter_transformations, restriction_specs) {
    .Call(`_bayesianVARs_find_rotation_cpp`, parameter_transformations, restriction_specs)
}
